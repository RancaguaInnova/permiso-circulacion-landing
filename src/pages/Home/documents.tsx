        ...
        <section className='documents text-left'>
            ...
            <div className='row-fluid'>
                <div className='col-md-12 location-box'>
                    ...
                    <p>2. Permiso de Circulación pago total año anterior.</p>
                    <p>3. Permiso de Circulación pago total año anterior.</p>
                    <p>4. Permiso de Circulación pago total año anterior.</p>
                </div>
            </div>
        </section>
    )
